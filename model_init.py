...
class Newmodel(Basemodel):
    ...
    def __init__(self, modeltype, representation, num_classes, freezed_layer, input_size, attention, pretrained=False):
...
def get_model(modeltype, representation, num_classes, freezed_layer, input_size, attention, pretrained=False):
    _model = Newmodel(modeltype, representation, num_classes, freezed_layer, input_size, attention,

...
def parse_arguments():
    ...
    args.in_dir = '/home/linkdata/yinxiaojie/datasets/ILSVRC2012/images'
    args.out_dir = '/home/linkdata/yinxiaojie/datasets/ImageNet-1K'
...
if __name__ == '__main__':
    input_dir, output_dir, alg_str, size, recurrent, full, every_nth, processes = parse_arguments()

    print('Starting ...')

    for fold in ['train', 'val']:
        in_dir = os.path.join(input_dir, fold)
        out_dir = os.path.join(output_dir, fold)
